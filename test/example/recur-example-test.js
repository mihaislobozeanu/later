...
describe('Recur Examples', function() {
  ...
  describe('instances', function() {
    ...
    it('At 11:30am on March 21, 2013', function() {
      ...
      const sched = later.parse.recur().on(new Date('2013-03-21T11:30:00Z')).fullDate();
      ...
      const prev = later.schedule(sched).prev(1, end, start);
    ...
    it('At 11:30am on March 21, 2013 starting past the date should not occur', function() {
      ...
      const sched = later.parse.recur().on(new Date('2013-03-21T11:30:00')).fullDate();
    ...
    it('Every 5 minutes', function() {
      ...
      const prev = later.schedule(sched).prev(8, end, start);
    ...
    it('Every second Tuesday at 4AM and 10PM', function() {
      ...
      const sched = later.parse.recur().on(2).dayOfWeekCount().on(3).dayOfWeek().on('4:00', '22:00').time();
    ...
    it('Last day of every month', function() {
      ...
      const prev = later.schedule(sched).prev(12, end, start);
      prev.should.eql(expected.reverse());
    ...
    it('Last Wednesday of every month', function() {
      ...
      const sched = later.parse.recur().on(0).dayOfWeekCount().on(4).dayOfWeek();
  ...
  describe('ranges', function() {
    ...
    it('(1) After 15 minutes and before 30 minutes except multiples of 5 and 8', function() {
      ...
      const prev = later.schedule(sched).prevRange(10, end, start);
      prev.should.eql(expected.reverse());
    ...
    it('(2) After 15 minutes and before 30 minutes except multiples of 5 and 8', function() {
      ...
      const prev = later.schedule(sched).prevRange(8, end, start);
      prev.should.eql(expected.reverse());
    ...
    it('After 30 minutes except seconds multiples of 5', function() {
      ...
      const sched = later.parse.recur().after(30).minute().except().every(5).second();
    ...
    it('Every second after 30 minutes except seconds multiples of 5', function() {
      ...
      const sched = later.parse.recur().every(1).second().after(30).minute().except().every(5).second();
      ...
      const prev = later.schedule(sched).prevRange(3, end, start);
      prev.should.eql(expected.reverse());
    ...
    it('First 5 minutes of every hour', function() {
      ...
      const prev = later.schedule(sched).prevRange(7, end, start);
      prev.should.eql(expected.reverse());
    ...
    it('Every weekday between 8:30AM and 5:30PM', function() {
      ...
      const sched = later.parse.recur().after('8:30').time().before('17:30').time().onWeekday();
    ...
    it('Every weekend between 8AM and 5PM', function() {
      ...
      const sched = later.parse.recur().after(8).hour().before(17).hour().onWeekend();
